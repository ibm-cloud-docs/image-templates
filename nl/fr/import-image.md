...
Vous devez disposer d'une [instance IBM Cloud Object Storage](/docs/services/cloud-object-storage/basics?topic=cloud-object-storage-order-storage#creating-a-new-ibm-cloud-platform-account) commandée via la console {{site.data.keyword.cloud_notm}} (cloud.ibm.com) pour utiliser cette fonction d'importation. IBM Cloud Object Storage provenant de control.softlayer.com n'est pas pris en charge.
{: important}
...
1. Dans {{site.data.keyword.cos_full_notm}}, accédez à votre compartiment puis cliquez sur **Ajouter un objet** pour [télécharger](/docs/services/cloud-object-storage?topic=cloud-object-storage-upload-data#upload-data) l'image.
2. Utilisez le plug-in de transfert à haut débit [Aspera](/docs/services/cloud-object-storage?topic=cloud-object-storage-use-aspera-high-speed-transfer#use-aspera-high-speed-transfer) pour
...
1. Dans le portail [{{site.data.keyword.slportal}} ![Icône de lien externe](../../icons/launch-glyph.svg "Icône de lien externe")](https://control.softlayer.com/) ou la console [{{site.data.keyword.cloud_notm}} ![Icône de lien externe](../../icons/launch-glyph.svg "Icône de lien externe")](https://cloud.ibm.com/classic), accédez à la page **Modèles d'image** en sélectionnant **Unités > Gérer > Images**.  
...
| Instance de service {{site.data.keyword.keymanagementserviceshort}} | Sélectionnez une instance Key Protect dans votre compte à partir de la liste déroulante. L'instance Key Protect doit inclure la clé racine client que vous avez utilisée pour encapsuler votre clé de chiffrement de données. |
| Nom de la clé | Sélectionnez le nom de la clé racine dans l'instance de service {{site.data.keyword.keymanagementserviceshort}} que vous avez utilisée pour encapsuler votre clé de chiffrement de données. Pour plus d'informations, voir la rubrique relative à l'[affichage des clés](/docs/services/key-protect?topic=key-protect-view-keys#view-keys). |
